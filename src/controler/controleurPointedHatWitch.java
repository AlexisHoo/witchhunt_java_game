...
public class controleurPointedHatWitch {
	
	private vue1 window;
	
	public controleurPointedHatWitch(JButton AfficherJeu, JButton PointedHatC1, JButton PointedHatC2, JButton PointedHatC3, JButton PointedHatC4, JButton Valider3, JTextField CarteSelect, vue1 window) {
		this.window=window;
		
		AfficherJeu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int tour = Jeu.getInstance().getAccusation()-1;
		...
		Valider3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println(Jeu.getInstance().getListJoueur().get(tour).getEnMain());
				System.out.println(Jeu.getInstance().getListJoueur().get(tour).getEnJeu());
