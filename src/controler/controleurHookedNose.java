...
public class controleurHookedNose {
	
	private vue1 window;

	public controleurHookedNose(JTextField textHookedNose, JButton boutonHookedNose, vue1 window, JTextField nomJ1,  JTextField roleJ1, JButton Carte1, JButton Carte2, JButton Carte3, JButton Carte4, JButton Accuser, JTextField CarteSelect, JButton JouerHunt) {
		this.window=window;
		
		boutonHookedNose.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				Jeu.getInstance().setHookedNosePlayerMVC(textHookedNose);
				
				Jeu.getInstance().hookedNoseMVC();
